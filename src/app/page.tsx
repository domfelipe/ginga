...
import { HeroDemoLoop } from '@/components/store/HeroDemoLoop';
...
export default function Home() {
  return (
    <div className="relative flex flex-1 flex-col items-center justify-center overflow-hidden px-6 py-20 text-center lg:text-left">
      ...
      <div className="relative grid w-full max-w-5xl items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8">
        <div className="flex flex-col items-center gap-6 lg:items-start">
          <TaughtToolsBadge />

          <h1 className="font-display max-w-xl text-4xl font-semibold leading-[1.1] tracking-tight text-balance sm:text-5xl">
            Padaria Aurora —{' '}
        ...
        {/* silent product demo — ticket compiles into a live tool, on loop */}
        <HeroDemoLoop />
      </div>

      {/* how it works — three steps, static content */}
      <ol className="relative mt-12 grid w-full max-w-3xl gap-3 text-left sm:grid-cols-3">
        {STEPS.map((step, i) => (
          <li
            key={step.title}
      ...
      <footer className="relative mt-12 flex items-center justify-center gap-2 border-t border-border pt-6 text-xs text-muted-foreground lg:justify-start">
